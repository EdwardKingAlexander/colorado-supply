...
import { _ as _sfc_main$1 } from "./AuthenticatedLayout-DiECemAh.js";
import { P as PrimaryButton } from "./PrimaryButton-qTs2i3In.js";
import { _ as _sfc_main$2 } from "./InputError-C5XExbFq.js";
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (isPaid.value) {
              _push2(`<div class="rounded-lg border border-green-200 bg-green-50 p-4 text-base leading-6 text-green-800" role="status"${_scopeId}> This order has already been paid. `);
            ...
            ssrRenderList(__props.order.items, (item) => {
              _push2(`<div class="flex items-start justify-between gap-3 py-3 text-base"${_scopeId}><div${_scopeId}><p class="font-medium text-gray-900"${_scopeId}>${ssrInterpolate(item.name)}</p><p class="text-sm text-gray-600"${_scopeId}>Qty ${ssrInterpolate(item.quantity)} × ${ssrInterpolate(formatCurrency(item.unit_price))}</p></div><p class="font-semibold text-gray-900"${_scopeId}>${ssrInterpolate(formatCurrency(item.line_total))}</p></div>`);
            });
            _push2(`<!--]--></div><div class="border-t border-gray-200 pt-4 flex items-center justify-between"${_scopeId}><p class="text-sm font-semibold text-gray-700"${_scopeId}>Order Total</p><p class="text-xl font-bold text-gray-900"${_scopeId}>${ssrInterpolate(formatCurrency(__props.order.grand_total))}</p></div></div><div class="grid grid-cols-1 sm:grid-cols-2 gap-6"${_scopeId}><div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6"${_scopeId}><h3 class="mb-2 text-base font-semibold text-gray-900"${_scopeId}>Billing Address</h3><p class="whitespace-pre-line text-base leading-6 text-gray-600"${_scopeId}>${ssrInterpolate(formatAddress(__props.order.billing_address))}</p></div><div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6"${_scopeId}><h3 class="mb-2 text-base font-semibold text-gray-900"${_scopeId}>Shipping Address</h3><p class="whitespace-pre-line text-base leading-6 text-gray-600"${_scopeId}>${ssrInterpolate(formatAddress(__props.order.shipping_address))}</p></div></div></div><div class="lg:col-span-1"${_scopeId}><div class="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6 lg:sticky lg:top-20"${_scopeId}><h2 class="text-lg font-semibold text-gray-900"${_scopeId}>Choose a Payment Method</h2><div id="payment-methods" class="space-y-3"${_scopeId}>`);
            ...
            _push2(`<p class="text-sm leading-5 text-gray-600"${_scopeId}> Google Pay and Apple Pay are available automatically on the Stripe payment page when supported by your browser and device. </p>`);
            _push2(ssrRenderComponent(PrimaryButton, {
              type: "button",
              ...
              createVNode("div", { class: "bg-gray-50 min-h-screen" }, [
                createVNode("div", { class: "mobile-page-gutter mx-auto max-w-5xl space-y-6 py-6 sm:py-8 lg:px-8" }, [
                  ...
                  isPaid.value ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: "rounded-lg border border-green-200 bg-green-50 p-4 text-base leading-6 text-green-800",
                    role: "status"
                  }, [
                  ...
                  createVNode("div", { class: "grid grid-cols-1 lg:grid-cols-3 gap-6" }, [
                    createVNode("div", { class: "lg:col-span-2 space-y-6" }, [
                        ...
                        createVNode("div", { class: "divide-y divide-gray-100" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(__props.order.items, (item) => {
                            return openBlock(), createBlock("div", {
                              key: item.id,
                              class: "flex items-start justify-between gap-3 py-3 text-base"
                            }, [
                              createVNode("div", null, [
                                createVNode("p", { class: "font-medium text-gray-900" }, toDisplayString(item.name), 1),
                                createVNode("p", { class: "text-sm text-gray-600" }, "Qty " + toDisplayString(item.quantity) + " × " + toDisplayString(formatCurrency(item.unit_price)), 1)
                              ]),
                      ...
                      createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-2 gap-6" }, [
                        createVNode("div", { class: "rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6" }, [
                          createVNode("h3", { class: "mb-2 text-base font-semibold text-gray-900" }, "Billing Address"),
                          createVNode("p", { class: "whitespace-pre-line text-base leading-6 text-gray-600" }, toDisplayString(formatAddress(__props.order.billing_address)), 1)
                        ]),
                        createVNode("div", { class: "rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6" }, [
                          createVNode("h3", { class: "mb-2 text-base font-semibold text-gray-900" }, "Shipping Address"),
                          createVNode("p", { class: "whitespace-pre-line text-base leading-6 text-gray-600" }, toDisplayString(formatAddress(__props.order.shipping_address)), 1)
                        ])
                      ])
                    ]),
                    createVNode("div", { class: "lg:col-span-1" }, [
                      createVNode("div", { class: "space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-6 lg:sticky lg:top-20" }, [
                        ...
                        createVNode("div", {
                          ...
                          createVNode("p", { class: "text-sm leading-5 text-gray-600" }, " Google Pay and Apple Pay are available automatically on the Stripe payment page when supported by your browser and device. "),
                          createVNode(PrimaryButton, {
                            type: "button",
                            class: "w-full justify-center bg-[#ffc439] hover:bg-[#f0b932] text-gray-900 focus:bg-[#f0b932] focus:ring-[#ffc439] active:bg-[#f0b932]",
                            disabled: redirectingPaypal.value || isPaid.value,
