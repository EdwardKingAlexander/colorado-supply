...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<label${ssrRenderAttrs(mergeProps({ class: "block text-base font-medium leading-6 text-gray-700" }, _attrs))}>`);
      if (__props.value) {
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<input${ssrRenderAttrs((_temp0 = mergeProps({
        class: "min-h-12 rounded-md border-gray-300 px-3 py-2 text-base leading-6 shadow-sm focus:border-indigo-500 focus:ring-indigo-500",
        ref_key: "input",
        ref: input
