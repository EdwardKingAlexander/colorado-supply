      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4"${_scopeId}><h2 class="text-lg font-semibold text-gray-900"${_scopeId}>Billing Address</h2><div class="grid grid-cols-1 sm:grid-cols-2 gap-4"${_scopeId}><div class="sm:col-span-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              for: "billing_line1",
            ...
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><h2 class="text-lg font-semibold text-gray-900"${_scopeId}>Shipping Address</h2><label class="flex items-center gap-2 text-sm text-gray-700"${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(form.shipping_same_as_billing) ? ssrLooseContain(form.shipping_same_as_billing, null) : form.shipping_same_as_billing) ? " checked" : ""} class="rounded border-gray-300"${_scopeId}> Same as billing address </label></div>`);
            ...
            _push2(`</div></form><div class="lg:col-span-1"${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4 sticky top-24"${_scopeId}><h2 class="text-lg font-semibold text-gray-900"${_scopeId}>Order Summary</h2><div class="space-y-4 divide-y divide-gray-100"${_scopeId}><!--[-->`);
            ssrRenderList(groupedItems.value, (group, locationId) => {
              _push2(`<div class="pt-2 first:pt-0"${_scopeId}><p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2"${_scopeId}>${ssrInterpolate(locationNameById.value[locationId])}</p><!--[-->`);
              ssrRenderList(group, (item) => {
                _push2(`<div class="flex items-center justify-between text-sm py-1"${_scopeId}><div${_scopeId}><p class="font-medium text-gray-900"${_scopeId}>${ssrInterpolate(item.name)}</p><p class="text-xs text-gray-500"${_scopeId}>Qty ${ssrInterpolate(item.quantity)} × ${ssrInterpolate(formatCurrency(item.price))}</p></div><p class="font-semibold text-gray-900"${_scopeId}>${ssrInterpolate(formatCurrency(item.price * item.quantity))}</p></div>`);
              });
              _push2(`<!--]--></div>`);
            });
                    ...
                    createVNode("form", {
                      ...
                      createVNode("div", { class: "bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4" }, [
                        createVNode("div", { class: "flex items-center justify-between" }, [
                          ...
                          createVNode("label", { class: "flex items-center gap-2 text-sm text-gray-700" }, [
                        ...
                        createVNode("div", { class: "space-y-4 divide-y divide-gray-100" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(groupedItems.value, (group, locationId) => {
                            return openBlock(), createBlock("div", {
                              ...
                              createVNode("p", { class: "text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2" }, toDisplayString(locationNameById.value[locationId]), 1),
                              (openBlock(true), createBlock(Fragment, null, renderList(group, (item) => {
                                return openBlock(), createBlock("div", {
                                  ...
                                  createVNode("div", null, [
                                    ...
                                    createVNode("p", { class: "text-xs text-gray-500" }, "Qty " + toDisplayString(item.quantity) + " × " + toDisplayString(formatCurrency(item.price)), 1)
                                  ]),
