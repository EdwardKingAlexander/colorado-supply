import { onMounted, onUnmounted, computed, ref, mergeProps, useSSRContext, unref, withCtx, renderSlot, createVNode, createTextVNode, createBlock, createCommentVNode, openBlock, toDisplayString } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="min-h-screen bg-gray-100"><nav class="relative z-50 border-b border-gray-100 bg-white"><div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div class="flex h-16 justify-between"><div class="flex"><div class="flex shrink-0 items-center">`);
      ...
      _push(ssrRenderComponent(_sfc_main$4, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              showProfileLink.value ? (openBlock(), createBlock(_sfc_main$3, {
                key: 0,
                href: _ctx.route("profile.edit")
              }, {
                default: withCtx(() => [
              ...
              canLogout.value ? (openBlock(), createBlock(_sfc_main$3, {
                key: 2,
                href: _ctx.route("logout"),
                method: "post",
                as: "button"
      ...
      _push(`</div><div class="border-t border-gray-200 pb-1 pt-4"><div class="px-4"><div class="text-base font-medium text-gray-800">${ssrInterpolate(accountName.value)}</div>`);
      if (accountEmail.value) {
        _push(`<div class="text-sm font-medium text-gray-500">${ssrInterpolate(accountEmail.value)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (canLogout.value) {
        _push(`<div class="mt-3 space-y-1">`);
        if (showProfileLink.value) {
          _push(ssrRenderComponent(_sfc_main$1, {
            href: _ctx.route("profile.edit")
          }, {
