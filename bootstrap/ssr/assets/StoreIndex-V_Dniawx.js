...
import { _ as _sfc_main$5 } from "./AuthenticatedLayout-DiECemAh.js";
...
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const inputClasses = computed(() => {
      const base = "min-h-12 w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent text-base leading-6 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 bg-white dark:bg-gray-900";
      if (props.variant === "inline") {
    ...
    const buttonClasses = computed(() => {
      const base = "min-h-12 text-base font-semibold text-white rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed";
      if (props.variant === "inline") {
...
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "rounded-lg bg-white/95 p-4 shadow-lg ring-1 ring-gray-100 dark:bg-gray-900/90 dark:ring-gray-800" }, _attrs))}><div class="flex items-center justify-between mb-4"><h2 class="text-base font-semibold tracking-tight text-gray-900 dark:text-white"> Filter by Specs </h2>`);
      if (hasActiveFilters.value) {
        _push(`<button type="button" class="inline-flex min-h-12 items-center rounded-md px-3 text-sm font-semibold text-blue-700 hover:bg-blue-50 hover:text-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-600 dark:text-blue-300 dark:hover:bg-white/10"> Clear All (${ssrInterpolate(activeFilterCount.value)}) </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
        ...
        ssrRenderList(orderedFilters.value, (filter) => {
          ...
          if (isProductTypeFilter(filter)) {
            ...
            ssrRenderList(filter.values, (value) => {
              _push(`<label class="flex min-h-12 cursor-pointer items-center rounded px-2 py-2 transition hover:bg-gray-50 dark:hover:bg-gray-800"><input type="checkbox"${ssrRenderAttr("name", `filter-${filter.name}-${value}`)}${ssrRenderAttr("value", value)}${ssrIncludeBooleanAttr(isValueSelected(filter.name, value)) ? " checked" : ""} class="h-5 w-5 text-blue-600 focus:ring-blue-500 dark:ring-offset-gray-800 dark:focus:ring-blue-600"><span class="ml-3 text-base leading-6 text-gray-700 dark:text-gray-300">${ssrInterpolate(value)}</span></label>`);
            });
            _push(`<!--]--></div>`);
          } else if (filter.type === "string" || filter.type === "select") {
            _push(`<div class="space-y-1"><!--[-->`);
            ssrRenderList(filter.values, (value) => {
              _push(`<label class="flex min-h-12 cursor-pointer items-center rounded px-2 py-2 transition hover:bg-gray-50 dark:hover:bg-gray-800"><input type="radio"${ssrRenderAttr("name", `filter-${filter.name}`)}${ssrRenderAttr("value", value)}${ssrIncludeBooleanAttr(isValueSelected(filter.name, value)) ? " checked" : ""} class="h-5 w-5 text-blue-600 focus:ring-blue-500 dark:ring-offset-gray-800 dark:focus:ring-blue-600"><span class="ml-3 text-base leading-6 text-gray-700 dark:text-gray-300">${ssrInterpolate(value)}</span></label>`);
            });
            _push(`<!--]--></div>`);
          } else if (filter.type === "boolean") {
            _push(`<div class="space-y-1"><!--[-->`);
            ssrRenderList(["true", "false"], (value) => {
              _push(`<label class="flex min-h-12 cursor-pointer items-center rounded px-2 py-2 transition hover:bg-gray-50 dark:hover:bg-gray-800"><input type="radio"${ssrRenderAttr("name", `filter-${filter.name}`)}${ssrRenderAttr("value", value)}${ssrIncludeBooleanAttr(isValueSelected(filter.name, value)) ? " checked" : ""} class="h-5 w-5 text-blue-600 focus:ring-blue-500 dark:ring-offset-gray-800 dark:focus:ring-blue-600"><span class="ml-3 text-base leading-6 text-gray-700 dark:text-gray-300">${ssrInterpolate(value === "true" ? "Yes" : "No")}</span></label>`);
            });
            _push(`<!--]--></div>`);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "px-4 py-5 transition-all hover:bg-gray-50/70 dark:hover:bg-gray-800" }, _attrs))}><div class="hidden lg:grid lg:grid-cols-12 gap-4 items-center"><div class="col-span-1">`);
      ...
      _push(`</button></div></div><div class="space-y-4 lg:hidden"><div class="flex gap-3">`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("store.show", productSlug.value),
        class: "flex min-h-12 flex-shrink-0 items-start rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("store.show", productSlug.value),
        class: "inline-flex min-h-12 items-center rounded-md text-base font-semibold leading-6 text-gray-900 hover:text-gray-700 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 dark:text-white dark:hover:text-gray-300"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(__props.product.name)}`);
      ...
      _push(`</div></div><p class="text-base leading-6 text-gray-600 line-clamp-3 dark:text-gray-300">${ssrInterpolate(__props.product.description ?? "No description available.")}</p><div class="flex items-center gap-2"><button type="button" class="inline-flex h-12 w-12 items-center justify-center rounded-md border border-gray-300 text-xl font-semibold text-gray-700 transition-colors hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-600 disabled:cursor-not-allowed disabled:opacity-50"${ssrIncludeBooleanAttr(quantity.value <= 1) ? " disabled" : ""}> − </button><span class="w-10 text-center text-base font-semibold text-gray-900">${ssrInterpolate(quantity.value)}</span><button type="button" class="inline-flex h-12 w-12 items-center justify-center rounded-md border border-gray-300 text-xl font-semibold text-gray-700 transition-colors hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-600"> + </button><button type="button" class="min-h-12 flex-1 rounded-md bg-blue-700 px-4 py-3 text-base font-semibold text-white transition-colors hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60">`);
      if (justAdded.value) {
        _push(`<span class="inline-flex items-center gap-1"> Added <span aria-hidden="true">✓</span></span>`);
      } else {
        _push(`<span>Add to Cart</span>`);
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "overflow-hidden rounded-lg bg-white/95 shadow-xl ring-1 ring-gray-100 dark:bg-gray-900/90 dark:ring-gray-800" }, _attrs))}><div class="p-5 border-b border-gray-100 dark:border-gray-800"><h1 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Products</h1><p class="mt-1 text-base leading-6 text-gray-600 dark:text-gray-300">${ssrInterpolate(headerSubtitle.value)}</p></div><div class="hidden lg:grid lg:grid-cols-12 gap-4 px-5 py-3 bg-gray-50/90 dark:bg-gray-800/90 border-b border-gray-100 dark:border-gray-800 text-[11px] font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-[0.2em]"><div class="col-span-1">Image</div><div class="col-span-2">Part Number</div><div class="col-span-3">Name</div><div class="col-span-2">Description</div><div class="col-span-2">Price</div><div class="col-span-2 text-right">Cart</div></div>`);
      if (__props.loading) {
        ...
        if (__props.products.length) {
          ...
          _push(`<div class="p-4 text-center text-base text-gray-500 sm:p-10"><div class="inline-flex w-full flex-col items-center gap-2 rounded-lg border border-dashed border-gray-300 px-4 py-6 shadow-sm sm:w-auto sm:px-8 dark:border-gray-600"><p class="font-semibold text-lg text-gray-800 dark:text-gray-100">No products match your filters</p><p class="text-sm text-gray-500 dark:text-gray-400"> Try removing a filter, widening the search term, or browsing categories. </p><div class="mt-4 flex flex-wrap justify-center gap-2"><button type="button" class="inline-flex min-h-12 items-center rounded-md border border-gray-300 px-4 py-3 text-base font-semibold text-gray-700 transition hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-600 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-800"> Clear filters </button><button type="button" class="inline-flex min-h-12 items-center rounded-md border border-gray-300 px-4 py-3 text-base font-semibold text-gray-700 transition hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-600 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-800"> Browse categories </button></div></div></div>`);
        }
        _push(`<!--]-->`);
      }
      if (showPagination.value) {
        _push(`<div class="flex items-center justify-between gap-2 border-t border-gray-100 bg-gray-50/60 px-4 py-4 text-base dark:border-gray-800 dark:bg-gray-900/60 sm:px-5"><button type="button" class="${ssrRenderClass([canGoPrevious.value ? "border-gray-300 text-gray-700 hover:bg-gray-50" : "border-gray-200 text-gray-400 cursor-not-allowed", "inline-flex min-h-12 min-w-12 items-center justify-center rounded-md border px-3 py-3 font-medium transition sm:px-4"])}"${ssrIncludeBooleanAttr(!canGoPrevious.value) ? " disabled" : ""}> Previous </button><p class="text-sm text-gray-600"> Page ${ssrInterpolate(__props.currentPage)} of ${ssrInterpolate(__props.totalPages)}</p><button type="button" class="${ssrRenderClass([canGoNext.value ? "border-gray-300 text-gray-700 hover:bg-gray-50" : "border-gray-200 text-gray-400 cursor-not-allowed", "inline-flex min-h-12 min-w-12 items-center justify-center rounded-md border px-3 py-3 font-medium transition sm:px-4"])}"${ssrIncludeBooleanAttr(!canGoNext.value) ? " disabled" : ""}> Next </button></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="bg-gray-50 dark:bg-gray-900 min-h-screen"${_scopeId}><div class="mobile-page-gutter mx-auto max-w-7xl py-6 sm:py-8 lg:px-8"${_scopeId}><div class="mb-4 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between"${_scopeId}><div class="space-y-2"${_scopeId}><p class="text-sm font-semibold uppercase text-gray-600 dark:text-gray-300"${_scopeId}>Industrial Supply Catalog</p><h1 class="text-3xl font-bold leading-10 text-gray-900 dark:text-white"${_scopeId}>Browse products &amp; build your cart</h1><p class="text-base leading-6 text-gray-600 dark:text-gray-300"${_scopeId}> Use the search bar and filters below to zero in on the exact specs you need. </p></div>`);
            ...
            _push2(`</div><div class="sticky top-16 z-20 -mx-4 mb-6 sm:-mx-6 lg:-mx-8 lg:mb-8"${_scopeId}><div class="space-y-3 border-y border-gray-200 bg-gray-50/95 px-4 py-3 shadow-sm backdrop-blur sm:px-6 lg:rounded-b-lg lg:border-x lg:px-8 dark:border-gray-700 dark:bg-gray-900/95"${_scopeId}>`);
            ...
            if (breadcrumbTrail.value.length) {
              _push2(`<div class="flex flex-wrap items-center gap-1 text-sm font-medium text-gray-600 dark:text-gray-300"${_scopeId}><!--[-->`);
              ssrRenderList(breadcrumbTrail.value, (crumb, index) => {
                _push2(`<!--[-->`);
                if (crumb.clickable) {
                  _push2(`<button type="button" class="inline-flex min-h-12 items-center rounded-md px-2 text-blue-700 hover:bg-blue-50 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 dark:text-blue-300 dark:hover:bg-white/10"${_scopeId}>${ssrInterpolate(crumb.label)}</button>`);
                } else {
            ...
            if (activeFilterPills.value.length) {
              ...
              ssrRenderList(activeFilterPills.value, (pill) => {
                _push2(`<button type="button" class="inline-flex min-h-12 items-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm transition hover:border-blue-500 hover:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:hover:border-blue-400 dark:hover:text-blue-300"${_scopeId}><span${_scopeId}>${ssrInterpolate(pill.label)}</span><svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"${_scopeId}></path></svg></button>`);
              });
              _push2(`<!--]-->`);
              if (hasRemovableFilters.value) {
                _push2(`<button type="button" class="ml-auto inline-flex min-h-12 items-center rounded-md px-3 text-sm font-semibold text-blue-700 hover:bg-blue-50 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-600 dark:text-blue-300 dark:hover:bg-white/10"${_scopeId}> Clear filters </button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            if (showingProductView.value) {
              ...
              if (showFilters.value) {
                _push2(`<div class="col-span-12 lg:hidden"${_scopeId}><button type="button" class="inline-flex min-h-12 w-full items-center justify-between rounded-md border border-gray-300 bg-white px-4 py-3 text-base font-semibold text-gray-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600 dark:border-gray-600 dark:bg-gray-800 dark:text-white"${_scopeId}><span${_scopeId}>Filters</span>`);
                if (activeFilterCount.value) {
                  _push2(`<span class="rounded-full bg-blue-700 px-2.5 py-1 text-sm font-bold text-white"${_scopeId}>${ssrInterpolate(activeFilterCount.value)}</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</button></div>`);
              ...
              if (showFilters.value) {
                _push2(`<div class="hidden lg:col-span-3 lg:block"${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(unref(Dialog), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="fixed inset-0 z-40 bg-gray-950/55" aria-hidden="true"${_scopeId2}></div>`);
                  _push3(ssrRenderComponent(unref(DialogPanel), { class: "safe-y fixed inset-y-0 right-0 z-50 flex w-full max-w-drawer flex-col bg-gray-50 shadow-2xl dark:bg-gray-900" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="flex h-16 shrink-0 items-center justify-between border-b border-gray-200 px-4 dark:border-gray-700"${_scopeId3}><h2 class="text-lg font-semibold text-gray-900 dark:text-white"${_scopeId3}>Filter products</h2><button type="button" class="inline-flex h-12 w-12 items-center justify-center rounded-md text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-600 dark:text-gray-200 dark:hover:bg-white/10" aria-label="Close filters"${_scopeId3}><svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"${_scopeId3}><path stroke-linecap="round" d="M6 6l12 12M18 6L6 18"${_scopeId3}></path></svg></button></div><div class="min-h-0 flex-1 overflow-y-auto p-4"${_scopeId3}>`);
                        ...
                        _push4(`</div><div class="safe-bottom shrink-0 border-t border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800"${_scopeId3}><button type="button" class="inline-flex min-h-12 w-full items-center justify-center rounded-md bg-blue-700 px-4 py-3 text-base font-semibold text-white hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"${_scopeId3}>Show products</button></div>`);
                      } else {
                        return [
                          createVNode("div", { class: "flex h-16 shrink-0 items-center justify-between border-b border-gray-200 px-4 dark:border-gray-700" }, [
                            createVNode("h2", { class: "text-lg font-semibold text-gray-900 dark:text-white" }, "Filter products"),
                            createVNode("button", {
                              type: "button",
                              class: "inline-flex h-12 w-12 items-center justify-center rounded-md text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-600 dark:text-gray-200 dark:hover:bg-white/10",
                          ...
                          createVNode("div", { class: "min-h-0 flex-1 overflow-y-auto p-4" }, [
                          ...
                          createVNode("div", { class: "safe-bottom shrink-0 border-t border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800" }, [
                            createVNode("button", {
                              type: "button",
                              class: "inline-flex min-h-12 w-full items-center justify-center rounded-md bg-blue-700 px-4 py-3 text-base font-semibold text-white hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2",
                              onClick: ($event) => mobileFiltersOpen.value = false
                            }, "Show products", 8, ["onClick"])
                          ])
                        ];
                      }
                    }),
                  ...
                  return [
                    ...
                    createVNode(unref(DialogPanel), { class: "safe-y fixed inset-y-0 right-0 z-50 flex w-full max-w-drawer flex-col bg-gray-50 shadow-2xl dark:bg-gray-900" }, {
                      default: withCtx(() => [
                        createVNode("div", { class: "flex h-16 shrink-0 items-center justify-between border-b border-gray-200 px-4 dark:border-gray-700" }, [
                          createVNode("h2", { class: "text-lg font-semibold text-gray-900 dark:text-white" }, "Filter products"),
                          createVNode("button", {
            ...
            return [
              createVNode("div", { class: "bg-gray-50 dark:bg-gray-900 min-h-screen" }, [
                createVNode("div", { class: "mobile-page-gutter mx-auto max-w-7xl py-6 sm:py-8 lg:px-8" }, [
                  createVNode("div", { class: "mb-4 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between" }, [
                    createVNode("div", { class: "space-y-2" }, [
                      createVNode("p", { class: "text-sm font-semibold uppercase text-gray-600 dark:text-gray-300" }, "Industrial Supply Catalog"),
                      createVNode("h1", { class: "text-3xl font-bold leading-10 text-gray-900 dark:text-white" }, "Browse products & build your cart"),
                      createVNode("p", { class: "text-base leading-6 text-gray-600 dark:text-gray-300" }, " Use the search bar and filters below to zero in on the exact specs you need. ")
                    ]),
                  ...
                  createVNode("div", { class: "sticky top-16 z-20 -mx-4 mb-6 sm:-mx-6 lg:-mx-8 lg:mb-8" }, [
                    createVNode("div", { class: "space-y-3 border-y border-gray-200 bg-gray-50/95 px-4 py-3 shadow-sm backdrop-blur sm:px-6 lg:rounded-b-lg lg:border-x lg:px-8 dark:border-gray-700 dark:bg-gray-900/95" }, [
                  ...
                  showingProductView.value ? (openBlock(), createBlock("div", {
                    ...
                    showFilters.value ? (openBlock(), createBlock("div", {
                      key: 0,
                      class: "col-span-12 lg:hidden"
                    }, [
                      createVNode("button", {
                        type: "button",
                        class: "inline-flex min-h-12 w-full items-center justify-between rounded-md border border-gray-300 bg-white px-4 py-3 text-base font-semibold text-gray-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600 dark:border-gray-600 dark:bg-gray-800 dark:text-white",
                        onClick: ($event) => mobileFiltersOpen.value = true
                      }, [
                        createVNode("span", null, "Filters"),
                        activeFilterCount.value ? (openBlock(), createBlock("span", {
                          key: 0,
                          class: "rounded-full bg-blue-700 px-2.5 py-1 text-sm font-bold text-white"
                        }, toDisplayString(activeFilterCount.value), 1)) : createCommentVNode("", true)
                      ], 8, ["onClick"])
                    ])) : createCommentVNode("", true),
                    showFilters.value ? (openBlock(), createBlock("div", {
                      key: 1,
                      class: "hidden lg:col-span-3 lg:block"
                    }, [
                      createVNode(_sfc_main$3, {
                        filters: availableFilters.value,
                        "active-filters": activeFilters.value,
