...
import { _ as _sfc_main$6 } from "./AppLayout-BeNNp45Q.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({
    id: "repair-top",
    class: "relative isolate overflow-hidden bg-white pb-16 pt-28 sm:pb-24 sm:pt-36 dark:bg-gray-900"
  }, _attrs))}><div class="mobile-page-gutter mx-auto max-w-7xl lg:px-8"><div class="mx-auto max-w-2xl text-center"><p class="mb-4 text-base font-extrabold leading-6 text-primary-800 dark:text-primary-300"> Industrial Repair Program </p><h1 class="text-3xl font-bold leading-10 tracking-normal text-gray-900 sm:text-5xl sm:leading-tight dark:text-white"> Expert Industrial Electronics &amp; Motor Repair — Fast, Reliable, Guaranteed </h1><p class="mx-auto mt-6 max-w-2xl text-base leading-7 text-gray-600 sm:mt-8 sm:text-xl sm:leading-8 dark:text-gray-300"> Colorado Supply &amp; Procurement repairs, sells, and services industrial electronics, servo motors, AC &amp; DC motors, and hydraulics &amp; pneumatics — often for a fraction of the cost of new equipment. Every job starts with a free, risk-free evaluation, with no freight cost and nothing due upfront. If a unit can&#39;t be repaired, we&#39;ll source and quote a suitable alternative. </p><div class="mx-auto mt-8 flex max-w-md flex-col items-stretch justify-center gap-3 sm:mt-10 sm:max-w-none sm:flex-row sm:items-center sm:gap-4"><a href="#repair-form" class="inline-flex min-h-12 w-full items-center justify-center rounded-md bg-primary-700 px-5 py-3 text-base font-semibold text-white shadow-md transition-colors hover:bg-primary-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-700 sm:w-auto"> Request a Repair Quote </a><a href="tel:7194259634" class="inline-flex min-h-12 w-full items-center justify-center rounded-md px-5 py-3 text-base font-semibold text-gray-900 hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-700 sm:w-auto dark:text-gray-100 dark:hover:bg-white/10"> Call (719) 425-9634 → </a></div></div></div></section>`);
}
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="mobile-page-gutter mx-auto max-w-7xl lg:px-8"><div class="mx-auto max-w-2xl text-center"><h2 class="text-base font-semibold text-amber-600 dark:text-amber-400">Why Repair With Us</h2><p class="mt-2 text-3xl font-bold leading-10 tracking-normal text-gray-900 sm:text-4xl dark:text-white"> The Colorado Supply Repair Advantage </p><p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300"> A straightforward, low-risk way to get critical equipment back in service. </p></div><div class="mx-auto mt-16 max-w-4xl grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3"><div class="flex flex-col items-start">`);
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="mobile-page-gutter mx-auto max-w-7xl lg:px-8"><div class="mx-auto max-w-2xl text-center"><h2 class="text-base font-semibold text-amber-600 dark:text-amber-400">What We Repair</h2><p class="mt-2 text-3xl font-bold leading-10 tracking-normal text-gray-900 sm:text-4xl dark:text-white"> Equipment Categories </p><p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300"> A broad range of industrial equipment, backed by the same repair program regardless of category. </p></div><div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:grid-cols-2 lg:max-w-none"><!--[-->`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        id: "repair-process",
        class: "scroll-mt-20 bg-white py-16 sm:py-24 dark:bg-gray-900"
      }, _attrs))}><div class="mobile-page-gutter mx-auto max-w-7xl lg:px-8"><div class="mx-auto max-w-2xl text-center"><h2 class="text-base font-semibold text-amber-600 dark:text-amber-400">How It Works</h2><p class="mt-2 text-3xl font-bold leading-10 tracking-normal text-gray-900 sm:text-4xl dark:text-white"> Simple, Transparent Process </p></div><div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-12 sm:grid-cols-2 lg:max-w-none lg:grid-cols-5"><!--[-->`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        id: "repair-form",
        class: "scroll-mt-20 bg-gray-50 py-16 sm:py-24 dark:bg-gray-800"
      }, _attrs))}><div class="mobile-page-gutter mx-auto max-w-7xl lg:px-8"><div class="mx-auto max-w-2xl text-center"><h2 class="text-base font-semibold text-amber-600 dark:text-amber-400">Get Started</h2><p class="mt-2 text-3xl font-bold leading-10 tracking-normal text-gray-900 sm:text-4xl dark:text-white"> Request a Repair Quote </p><p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300"> Tell us about your equipment and we&#39;ll follow up with a free evaluation and quote. Only your name, email, equipment type, model number, and a description of the issue are required — everything else helps us move faster, but isn&#39;t required. </p></div><div class="mx-auto mt-12 max-w-2xl sm:mt-16"><form class="space-y-6 rounded-lg bg-white p-4 shadow-sm ring-1 ring-gray-900/5 sm:p-8 dark:bg-gray-900 dark:ring-white/10"><div class="grid grid-cols-1 gap-6 sm:grid-cols-2"><div><label for="repair-name" class="block text-sm font-semibold text-gray-900 dark:text-white">Name *</label><input id="repair-name" type="text" autocomplete="name"${ssrRenderAttr("value", form.value.name)} required class="mt-2 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3.5 py-2 text-gray-900 dark:text-white shadow-sm focus:ring-2 focus:ring-amber-600 sm:text-sm">`);
      if (errors.value.name) {
        _push(`<p class="text-red-600 text-sm mt-1">${ssrInterpolate(errors.value.name[0])}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div><label for="repair-email" class="block text-sm font-semibold text-gray-900 dark:text-white">Email *</label><input id="repair-email" type="email" autocomplete="email"${ssrRenderAttr("value", form.value.email)} required class="mt-2 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3.5 py-2 text-gray-900 dark:text-white shadow-sm focus:ring-2 focus:ring-amber-600 sm:text-sm">`);
      if (errors.value.email) {
        _push(`<p class="text-red-600 text-sm mt-1">${ssrInterpolate(errors.value.email[0])}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div><label for="repair-phone" class="block text-sm font-semibold text-gray-900 dark:text-white">Phone</label><input id="repair-phone" type="tel" inputmode="tel" autocomplete="tel"${ssrRenderAttr("value", form.value.phone)} class="mt-2 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3.5 py-2 text-gray-900 dark:text-white shadow-sm focus:ring-2 focus:ring-amber-600 sm:text-sm">`);
      if (errors.value.phone) {
        _push(`<p class="text-red-600 text-sm mt-1">${ssrInterpolate(errors.value.phone[0])}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div><label for="repair-company" class="block text-sm font-semibold text-gray-900 dark:text-white">Company</label><input id="repair-company" type="text" autocomplete="organization"${ssrRenderAttr("value", form.value.company)} class="mt-2 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3.5 py-2 text-gray-900 dark:text-white shadow-sm focus:ring-2 focus:ring-amber-600 sm:text-sm">`);
