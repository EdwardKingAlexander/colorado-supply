...
import { _ as _sfc_main$1 } from "./GuestLayout-D6DPq49i.js";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="mb-5 text-base leading-6 text-gray-600"${_scopeId}> Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one. </div>`);
            if (__props.status) {
              _push2(`<div class="mb-4 text-base font-medium leading-6 text-green-700" role="status"${_scopeId}>${ssrInterpolate(__props.status)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(`</div><div class="mt-5 flex items-center"${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", { class: "mb-5 text-base leading-6 text-gray-600" }, " Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one. "),
