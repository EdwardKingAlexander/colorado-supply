...
import { _ as _sfc_main$2 } from "./BrandedAuthLayout-C1BpIGle.js";
import { _ as _sfc_main$5 } from "./InputError-C5XExbFq.js";
import { _ as _sfc_main$3, a as _sfc_main$4 } from "./TextInput-CcK4WCIH.js";
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<input${ssrRenderAttrs((_temp0 = mergeProps({
        ...
        class: "h-5 w-5 shrink-0 rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
      ...
      _push(ssrRenderComponent(_sfc_main$2, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.status) {
              _push2(`<div class="mb-6 border-l-4 border-green-500 bg-green-50 px-4 py-3 text-base font-medium leading-6 text-green-800" role="status"${_scopeId}>${ssrInterpolate(__props.status)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(`</div><div class="flex flex-col items-stretch gap-2 xs:flex-row xs:items-center xs:justify-between"${_scopeId}><label class="flex min-h-12 items-center rounded-md px-1 focus-within:ring-2 focus-within:ring-amber-500"${_scopeId}>`);
            ...
            _push2(`<span class="ms-3 text-base text-gray-700"${_scopeId}>Remember me</span></label>`);
            ...
            _push2(`</div><div class="flex flex-col gap-4 pt-2 sm:flex-row sm:items-center sm:justify-between"${_scopeId}><p class="text-base leading-6 text-gray-600"${_scopeId}> New to Colorado Supply? `);
            _push2(ssrRenderComponent(unref(Link), {
            ...
            return [
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "flex flex-col items-stretch gap-2 xs:flex-row xs:items-center xs:justify-between" }, [
                  createVNode("label", { class: "flex min-h-12 items-center rounded-md px-1 focus-within:ring-2 focus-within:ring-amber-500" }, [
                    ...
                    createVNode("span", { class: "ms-3 text-base text-gray-700" }, "Remember me")
                  ]),
