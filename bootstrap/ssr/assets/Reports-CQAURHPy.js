...
import { _ as _sfc_main$3 } from "./AuthenticatedLayout-BXbec8wQ.js";
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "dashboard-filter rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:p-5" }, _attrs))}><div class="grid gap-4 md:grid-cols-6"><label class="text-base"><span class="font-medium text-gray-700">Range</span><select class="mt-2 block w-full rounded-md border-gray-300 text-base"><option value="this_month"${ssrIncludeBooleanAttr(Array.isArray(form.range) ? ssrLooseContain(form.range, "this_month") : ssrLooseEqual(form.range, "this_month")) ? " selected" : ""}>This month</option><option value="last_30_days"${ssrIncludeBooleanAttr(Array.isArray(form.range) ? ssrLooseContain(form.range, "last_30_days") : ssrLooseEqual(form.range, "last_30_days")) ? " selected" : ""}>Last 30 days</option><option value="quarter_to_date"${ssrIncludeBooleanAttr(Array.isArray(form.range) ? ssrLooseContain(form.range, "quarter_to_date") : ssrLooseEqual(form.range, "quarter_to_date")) ? " selected" : ""}>Quarter to date</option><option value="year_to_date"${ssrIncludeBooleanAttr(Array.isArray(form.range) ? ssrLooseContain(form.range, "year_to_date") : ssrLooseEqual(form.range, "year_to_date")) ? " selected" : ""}>Year to date</option><option value="last_12_months"${ssrIncludeBooleanAttr(Array.isArray(form.range) ? ssrLooseContain(form.range, "last_12_months") : ssrLooseEqual(form.range, "last_12_months")) ? " selected" : ""}>Last 12 months</option><option value="custom"${ssrIncludeBooleanAttr(Array.isArray(form.range) ? ssrLooseContain(form.range, "custom") : ssrLooseEqual(form.range, "custom")) ? " selected" : ""}>Custom</option></select></label><label class="text-base"><span class="font-medium text-gray-700">Start</span><input${ssrRenderAttr("value", form.start_date)} type="date"${ssrIncludeBooleanAttr(form.range !== "custom") ? " disabled" : ""} class="mt-2 block w-full rounded-md border-gray-300 text-base disabled:bg-gray-100"></label><label class="text-base"><span class="font-medium text-gray-700">End</span><input${ssrRenderAttr("value", form.end_date)} type="date"${ssrIncludeBooleanAttr(form.range !== "custom") ? " disabled" : ""} class="mt-2 block w-full rounded-md border-gray-300 text-base disabled:bg-gray-100"></label><label class="text-base"><span class="font-medium text-gray-700">Group by</span><select class="mt-2 block w-full rounded-md border-gray-300 text-base"><!--[-->`);
      ...
      _push(`<!--]--></select></label><label class="text-base"><span class="font-medium text-gray-700">Location</span><select class="mt-2 block w-full rounded-md border-gray-300 text-base"><option value=""${ssrIncludeBooleanAttr(Array.isArray(form.location_id) ? ssrLooseContain(form.location_id, "") : ssrLooseEqual(form.location_id, "")) ? " selected" : ""}>All</option><!--[-->`);
      ...
      _push(`<!--]--></select></label><label class="text-base"><span class="font-medium text-gray-700">Sublocation</span><select class="mt-2 block w-full rounded-md border-gray-300 text-base"><option value=""${ssrIncludeBooleanAttr(Array.isArray(form.sublocation_id) ? ssrLooseContain(form.sublocation_id, "") : ssrLooseEqual(form.sublocation_id, "")) ? " selected" : ""}>All</option><!--[-->`);
      ssrRenderList(__props.filters.options.locations, (location) => {
        _push(`<!--[--><!--[-->`);
      ...
      _push(`<!--]--></select></label></div><div class="mt-5 grid gap-2 xs:grid-cols-2 sm:flex"><button type="button" class="inline-flex min-h-12 items-center justify-center rounded-md bg-gray-900 px-4 py-3 text-base font-semibold text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500"> Preview report </button><a${ssrRenderAttr("href", exportUrl())} class="inline-flex min-h-12 items-center justify-center rounded-md border border-gray-300 px-4 py-3 text-base font-semibold text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500"> Export CSV </a></div></section>`);
    };
  }
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.rows, (row, index) => {
        _push(`<tr><!--[-->`);
        ssrRenderList(__props.columns, (column) => {
          _push(`<td${ssrRenderAttr("data-label", label(column))} class="whitespace-nowrap px-5 py-3 text-gray-700">${ssrInterpolate(format(row[column], column))}</td>`);
        });
        _push(`<!--]--></tr>`);
      });
      _push(`<!--]-->`);
                ...
                createVNode("div", { class: "mobile-page-gutter mx-auto max-w-7xl space-y-6 py-6 lg:px-8" }, [
                  createVNode("div", { class: "flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between" }, [
                    createVNode("div", null, [
                      ...
                      createVNode("p", { class: "mt-1 text-base leading-6 text-gray-600" }, "Preview and export spending by month, location, sublocation, product, or order.")
                    ]),
