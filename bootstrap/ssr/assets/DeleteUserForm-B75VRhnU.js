...
import { _ as _sfc_main$6 } from "./InputError-C5XExbFq.js";
import { _ as _sfc_main$4, a as _sfc_main$5 } from "./TextInput-CcK4WCIH.js";
import { _ as _sfc_main$3 } from "./Modal-CPfU9EoI.js";
import { useForm } from "@inertiajs/vue3";
const _sfc_main$2 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<button${ssrRenderAttrs(mergeProps({ class: "inline-flex min-h-12 items-center justify-center gap-2 rounded-md border border-transparent bg-red-600 px-4 py-3 text-base font-semibold leading-6 tracking-normal text-white transition duration-150 ease-in-out hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 active:bg-red-700 disabled:cursor-not-allowed disabled:opacity-50" }, _attrs))}>`);
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        type: __props.type,
        class: "inline-flex min-h-12 items-center justify-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-3 text-base font-semibold leading-6 tracking-normal text-gray-700 shadow-sm transition duration-150 ease-in-out hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
      }, _attrs))}>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</button>`);
    };
