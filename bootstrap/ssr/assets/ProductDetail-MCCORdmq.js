    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="bg-gray-50 min-h-screen"${_scopeId}><div class="mobile-page-gutter mx-auto max-w-7xl py-6 sm:py-8 lg:px-8"${_scopeId}><div class="mb-6"${_scopeId}>`);
            ...
            if (loading.value) {
              ...
              _push2(`</div><div class="flex-shrink-0 text-left sm:text-right"${_scopeId}><p class="text-3xl font-bold text-gray-900 dark:text-white"${_scopeId}>${ssrInterpolate(priceDisplay.value)}</p><p class="text-sm text-gray-500 dark:text-gray-400 mt-1"${_scopeId}> per ${ssrInterpolate(unitLabel.value)}</p>`);
              ...
              _push2(`<div class="pt-4"${_scopeId}><button type="button" class="min-h-12 w-full rounded-md bg-gray-900 px-6 py-3 text-base font-semibold text-white transition-colors hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60"${_scopeId}>`);
              if (justAdded.value) {
              ...
              _push2(`</button><p class="mt-3 text-center text-sm leading-5 text-gray-600"${_scopeId}> Questions? Contact our sales team for assistance. </p></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div>`);
              ...
              createVNode("div", { class: "bg-gray-50 min-h-screen" }, [
                createVNode("div", { class: "mobile-page-gutter mx-auto max-w-7xl py-6 sm:py-8 lg:px-8" }, [
                  ...
                  loading.value ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "border-b border-gray-200 px-4 py-5 dark:border-gray-700 sm:px-8 sm:py-6" }, [
                      createVNode("div", { class: "flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between" }, [
                        ...
                        createVNode("div", { class: "flex-shrink-0 text-left sm:text-right" }, [
                    ...
                    createVNode("div", { class: "grid grid-cols-1 gap-8 p-4 sm:p-8 lg:grid-cols-2" }, [
                      createVNode("div", { class: "space-y-4" }, [
                        createVNode("div", {
                      ...
                      createVNode("div", { class: "space-y-6" }, [
                        ...
                        createVNode("div", { class: "pt-4" }, [
                          ...
                          createVNode("p", { class: "mt-3 text-center text-sm leading-5 text-gray-600" }, " Questions? Contact our sales team for assistance. ")
                        ])
                      ])
                    ])
                  ])) : createCommentVNode("", true)
