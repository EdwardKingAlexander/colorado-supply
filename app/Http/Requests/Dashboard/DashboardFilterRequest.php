    ...
    public function rules(): array
    {
        $locationRule = Rule::exists('locations', 'id')
            ->where(fn ($query) => $query
                ...
                ->when($this->user('web')?->company_id, fn ($query, $companyId) => $query->where('company_id', $companyId)));
        ...
        return [
            ...
            'location_id' => ['nullable', 'integer', $locationRule],
            'sublocation_id' => ['nullable', 'integer', $locationRule],
